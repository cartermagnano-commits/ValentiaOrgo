...
// Polls the FastAPI backend /health (proxied by Next). Shows a fixed banner
// when the chemistry API is unreachable, so AI and structure failures are
// explained before the first panel errors out.
